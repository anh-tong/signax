...
from signax.utils import index_select, lyndon_words
...
def compress(input: List[jnp.ndarray], indices: List[jnp.ndarray]):
    """
...
if __name__ == "__main__":
    ...
    output = signature_to_logsignature(input1, dim, len(input1))
    print(output)
